...
public class PopularFragment extends Fragment {
    ...
    public void getMovies() {
        pDialog.show();
        String strURL = Constant.URL + "getMovies.php";
            ...
            public void onResponse(String strResponse) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++){
                        ...
                        movies.Genre    = jsonObject.getString("genre");
                        movies.Synopsis = jsonObject.getString("synopsis");
                        movies.Pic      = jsonObject.getString("pic");
                        movies.Rating   = jsonObject.getString("rating");

                        if (Integer.parseInt(jsonObject.getString("rating")) > 5) {
